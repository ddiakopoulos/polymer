...
#ifndef polymer_win32_utils_hpp
#define polymer_win32_utils_hpp

#include <string>
#include <cassert>
#include <sstream>

// `filter_type` is a human-readable hint as to the type of file shown in the dialog, extension is the actual extension WITHOUT the dot
