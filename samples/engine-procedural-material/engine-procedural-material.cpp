...
sample_engine_procedural_material::sample_engine_procedural_material() : polymer_app(1280, 720, "sample-engine-procedural-material")
{
...

    {
        ...
        auto ikeda_material_handle = scene.mat_library->register_material("ikeda-material", ikeda_material);
        ...
        payload.render_components.push_back(assemble_render_component(scene, debug_icosa));
    }
